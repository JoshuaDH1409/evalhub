...
namespace PlantillaMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult RecuperaContrasena()
        {
            ...
            PlantillaMVC.Models.RecuperarContraseña model = new RecuperarContraseña();
        ...
        [HttpGet]
        [AllowAnonymous]
        public ActionResult EnviarCorreoPass(RecuperarContraseña Correo)
        {
            ELogin modelo = Utilidades.negocio.RecuperaUnUsuarioCorreo(Correo.Email);
            ...
            if (modelo != null)
            {
                ...
                if (modelo.Email != null)
                {
                    ...
                    MandarCorreo.SendMail("Soporte", modelo.Email, " ", "Estimado:" + modelo.NombreCompleto + "<br><br><br>" + "Se le comunica que se re estableció la contraseña: <b>" + General.Encrypt.DesCifarado(modelo.Password) + "</b> <br><br><br> saludos<br>Atentamente Sistema de Evaluación de Desempeño  <br><br> *AUTOMATED SYSTEM MESSAGE - Please do not reply to this email*", "Recuperar contraseña");
                }
                else
                {
                    Bitacora.NuevaEntrada("No se encontró la siguiente cuenta " + Correo, "Account/EnviarCorreoPass ");
                    return PartialView("Respuesta", "Su correo no está registrado favor de ponerse en contacto con su administrador");
                }
                return PartialView("Respuesta", "Se notificó al correo ingresado");
            }
            else {
                return PartialView("Respuesta", "Ese correo no está registrado en la base de datos");
            }
        }
        ...
        public ActionResult Cerrarsession()
        {
            ...
            Bitacora.NuevaEntrada("Se cerró la sesión de  " + sesion.Login.NombreCompleto, "Account/Cerrarsession ");
            //Utilidades.negocio.GuardaLogLogin(sesion.Login, Utilidades.CerroSession);
            sesion = null;
